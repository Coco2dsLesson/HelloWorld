...
//	musicToggle = [](bool musicToggle){ return musicToggle;};
//	musicToggle(true);
//	toggle = true;
	return true;
}
...
//	auto sc = Setting::createScene();
	...
	auto scLayer = Setting::create();
	scLayer->musicToggle = std::bind(&HelloWorld::musicToggle, this, std::placeholders::_1);
	scLayer->musicToggle(toggle);
	sc->addChild(scLayer);
	auto reScene = TransitionJumpZoom::create(1.0f, sc);
	Director::getInstance()->pushScene(reScene);
}

bool HelloWorld::musicToggle(bool tog)
{
	return this->toggle = tog;
}
